...
Item.create(name: "Club", type: "Weapon", item_img: "", power_level: 1, character_id: character_id)
Item.create(name: "Dagger", type: "Weapon", item_img: "", power_level: 2, character_id: character_id)
Item.create(name: "Spear", type: "Weapon", item_img: "", power_level: 3, character_id: character_id)
Item.create(name: "Flail", type: "Weapon", item_img: "", power_level: 4, character_id: character_id)
Item.create(name: "Greatsword", type: "Weapon", item_img: "", power_level: 5, character_id: character_id)
Item.create(name: "Scimitar", type: "Weapon", item_img: "", power_level: 5, character_id: character_id)
Item.create(name: "Light Crossbow", type: "Weapon", item_img: "", power_level: 1, character_id: character_id)
Item.create(name: "Sling", type: "Weapon", item_img: "", power_level: 2, character_id: character_id)
Item.create(name: "Longbow", type: "Weapon", item_img: "", power_level: 4, character_id: character_id)
Item.create(name: "Heavy Crossbow", type: "Weapon", item_img: "", power_level: 6 , character_id: character_id)
Item.create(name: "Padded Armor", type: "Armor", item_img: "", power_level: 1, character_id: character_id)
Item.create(name: "Studded Leather", type: "Armor", item_img: "", power_level: 2, character_id: character_id)
Item.create(name: "Scale Mail", type: "Armor", item_img: "", power_level: 3, character_id: character_id)
Item.create(name: "Breastplate", type: "Armor", item_img: "", power_level: 4, character_id: character_id)
Item.create(name: "Chain Mail", type: "Armor", item_img: "", power_level: 6, character_id: character_id)
Item.create(name: "Plate", type: "Armor", item_img: "", power_level: 8, character_id: character_id)
Item.create(name: "Wooden Shield", type: "Off-hand", item_img: "",
power_level: 1, character_id: character_id)
Item.create(name: "Steel Shield", type: "Off-hand", item_img: "", power_level: 3, character_id: character_id)
Item.create(name: "Sorcerers Tome", type: "Off-hand", item_img: "", power_level: 4, character_id: character_id)
Item.create(name: "Dragon-leather Shield", type: "Off-hand", item_img: "", power_level: 4, character_id: character_id)
